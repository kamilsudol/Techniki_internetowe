...
function _list() {
   ...
   request.open("GET", "http://pascal.fis.agh.edu.pl/~8sudol/zadania_laby11/rest/list", true);
   request.send(null);
}
...
function _szukaj() {
   ...
   request.open("GET", "http://pascal.fis.agh.edu.pl/~8sudol/zadania_laby11/rest/find", true);
   request.send(null);
}
...
function _insert(form)  {
    ...
    request.open("POST", "http://pascal.fis.agh.edu.pl/~8sudol/zadania_laby11/rest/save", true);
    request.send(txt);
}
...
function _delete(form) {
    ...
    request.open("DELETE", "http://pascal.fis.agh.edu.pl/~8sudol/zadania_laby11/rest/delete1/"+id, true);
    request.send(null);
}
...
function _upd_form(form) {
    ...
    document.getElementById('data').innerHTML = '';  
  var form1 = "<form name='add'><table>" ;
  form1    += "<tr><td>ident</td><td><input type='text' name='ident' value='"+objJSON[id_mongo]['ident']+"' ></input></td></tr>";
  form1    += "<tr><td>fname</td><td><input type='text' name='fname' value='"+objJSON[id_mongo]['fname']+"' ></input></td></tr>";
  form1    += "<tr><td>lname</td><td><input type='text' name='lname' value='"+objJSON[id_mongo]['lname']+"' ></input></td></tr>";  
  form1    += "<tr><td>faculty</td><td><input type='text' name='faculty' value='"+objJSON[id_mongo]['faculty']+"' ></input></td></tr>";
  form1    += "<tr><td>year</td><td><input type='text' name='year' value='"+objJSON[id_mongo]['year']+"' ></input></td></tr>";
...
function _update(form) {
    ...
    request.open("PUT", "http://pascal.fis.agh.edu.pl/~8sudol/zadania_laby11/rest/update1/"+id_mongo, true);
    request.send(txt);
}