...
function _list() {
   ...
   request.open("GET", "http://pascal.fis.agh.edu.pl/~8sudol/zadania_laby12/rest/list", true);
   request.send(null);
}
...
function _insert(form)  {
    ...
    request.open("POST", "http://pascal.fis.agh.edu.pl/~8sudol/zadania_laby12/rest/save", true);
    request.send(txt);
}
...
print (id_mongo);
    request.open("DELETE", "http://pascal.fis.agh.edu.pl/~8sudol/zadania_laby12/rest/delete1/"+id_mongo, true);
    request.send(null);
}
...
function _update(form) {
   ...
   request.open("PUT", "http://pascal.fis.agh.edu.pl/~8sudol/zadania_laby12/rest/update1/"+id_mongo, true);
   request.send(txt);
}
...
function _szukaj() {
   ...
   form1    += "<tr><td>ident</td><td><input type='text' name='ident' value='ident' ></input></td></tr>";
   form1    += "<tr><td></td><td><input type='button' value='Szukaj' onclick='szukaj(this.form)'></input></td></tr>";
   form1    += "</table></form>";
   document.getElementById('data').innerHTML = form1;
   document.getElementById('result').innerHTML = ''; 
}

function szukaj(form) {
   var user = {};
   user.ident = form.ident.value;
   document.getElementById('result').innerHTML = ''; 
   document.getElementById('data').innerHTML = '';  
   ...
   request.open("GET", "http://pascal.fis.agh.edu.pl/~8sudol/zadania_laby12/rest/find/"+user.ident, true);
   request.send(null);
}